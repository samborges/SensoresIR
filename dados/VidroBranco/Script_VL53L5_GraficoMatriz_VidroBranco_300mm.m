...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_VidroLiquidoBranco_300mm_VL53L5.txt';
...
title('Sensor VL53L5 (Vidro Branco 300mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([280 380]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Vidro Branco 300mm)');

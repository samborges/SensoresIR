...
% Nome do arquivo CSV
filename = 'arrays\temperatura_AMG_8833\Array_DadosPlasticoLiquidoPreto_200mm_AMG8833.txt';
...
title('Sensor AMG 8833 (Plástico Preto 200mm)- Mapa de Calor (°C)');
colormap('cool')
xlabel('Base');
ylabel('Laterais');
...
ylim([30 60]);
title('Comparação dos Dados Originais e Filtrados (Plástico Preto 200mm)');
xlabel('Tempo seg');
ylabel('Valor °C');

...
title('Sensor AMG 8833 (Aluminio Natural 200mm)- Mapa de Calor (°C)');
colormap('cool')
xlabel('Base');
ylabel('Laterais');
...
ylim([25 50]);
title('Comparação dos Dados Originais e Filtrados (Aluminio Natural 200mm)');
xlabel('Tempo seg');
ylabel('Valor °C');

...
% Nome do arquivo CSV
filename = 'arrays\temperatura_AMG_8833\Array_DadosAluminioPreto_300mm_AMG8833.txt';
...
title('Sensor AMG 8833 (Aluminio Preto 300mm)- Mapa de Calor (°C)');
colormap('cool')
xlabel('Base');
ylabel('Laterais');
...
ylim([25 60]);
title('Comparação dos Dados Originais e Filtrados (Aluminio Preto 300mm)');
xlabel('Tempo seg');
ylabel('Valor °C');

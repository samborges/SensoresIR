...
% Nome do arquivo CSV
filename = 'arrays\temperatura_AMG_8833\Array_DadosVidroLiquidoPreto_300mm_AMG8833.txt';
...
title('Sensor AMG 8833 (Vidro Preto 300mm)- Mapa de Calor (°C)');
colormap('cool')
xlabel('Base');
ylabel('Laterais');
...
temperaturaCamera = 50.6;
temperaturaTermometro = 52;
...
ylim([30 60]);
% title('Comparação dos Dados Originais e Filtrados (Vidro Preto 300mm)');
xlabel('Tempo seg');
ylabel('Valor °C');

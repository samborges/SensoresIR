...
% Nome do arquivo CSV
filename = 'arrays\temperatura_AMG_8833\Array_DadosVidroLiquidoTransparente_300mm_AMG8833.txt';
...
title('Sensor AMG 8833 (Vidro Transparente 300mm)- Mapa de Calor (°C)');
colormap('cool')
xlabel('Base');
ylabel('Laterais');
...
ylim([30 60]);
% title('Comparação dos Dados Originais e Filtrados (Vidro Transparente 300mm)');
xlabel('Tempo seg');
ylabel('Valor °C');
...
variacao_percentual_1 = ((temperaturaMediaMovel*100) / temperaturaCamera ) - 100;
variacao_percentual_2 = ((temperaturaMediaMovel*100) / temperaturaTermometro ) - 100;

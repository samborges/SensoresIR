...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_AluminioPreto_200mm_VL53L5.txt';
...
title('Sensor VL53L5 (Alumínio Preto 200mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([180 380]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Alumínio Preto 200mm)');

...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_AluminioPreto_300mm_VL53L5.txt';
...
title('Sensor VL53L5 (Alumínio Preto300mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([280 400]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Alumínio Preto300mm)');

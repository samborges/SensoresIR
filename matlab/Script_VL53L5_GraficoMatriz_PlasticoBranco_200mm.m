...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_PlasticoLiquidoBranco_200mm_VL53L5.txt';
...
title('Sensor VL53L5 (Plástico Branco 200mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([180 280]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Plástico Branco 200mm)');

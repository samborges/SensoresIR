...
title('Sensor VL53L5 (Plastico Transparente 200mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([180 330]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Plastico Transparente 200mm)');

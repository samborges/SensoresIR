...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_VidroLiquidoPreto_200mm_VL53L5.txt';
...
title('Sensor VL53L5 (Vidro Preto 200mm) - Mapa distância (mm)');
colormap(flip(cool));
...
y_position = distanciaMediaMovel + 10 ; % Ajustar a posição Y acima da linha
...
ylim([180 280]);
% title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Vidro Preto 200mm)');

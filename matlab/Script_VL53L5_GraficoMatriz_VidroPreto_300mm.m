...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_VidroLiquidoPreto_300mm_VL53L5.txt';
...
title('Sensor VL53L5 (Vidro Preto 300mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([280 480]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Vidro Preto 300mm)');

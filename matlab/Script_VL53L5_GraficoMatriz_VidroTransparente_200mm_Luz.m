...
% Nome do arquivo CSV
filename = 'arrays\distancia_VL53L5cx\Array_VidroLiquidoTransparente_200mm_+luz_VL53L5.txt';
...
title('Sensor VL53L5 (Vidro Transparente 200mm) - Mapa distância (mm)');
colormap(flip(cool));
...
ylim([180 280]);
title('Sensor VL53L5 - Comparação dos Dados Originais e Filtrados (Vidro Transparente 200mm)');
